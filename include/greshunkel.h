 ...
 * xXx DESCRIPTION=Adds a name sub-context to a parent context. Sub-context values can be references via the 'x Xx @<name>.<value> xX x' syntax. Contexts added in this way will be freed by the parent. xXx
 * xXx RETURNS=0 on success, 1 otherwise. xXx
